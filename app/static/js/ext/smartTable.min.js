...
!function (t, e) {
    ...
    t.module("smart-table", []).run(["$templateCache", function (t) {
        ...
        search: {delay: 400, inputEvent: "input"},
        ...
        function c(t, e) {
            if (-1 != e.indexOf(".")) {
                var a = e.split("."), s = a.pop(), i = a.join("."), r = n(i)(t);
                delete r[s], 0 == Object.keys(r).length && c(t, i)
            } else delete t[e]
        }

        var o, u, p, g = i.stTable, d = n(g), f = d.assign, m = s("orderBy"), h = s("filter"), b = r(d(a)), P = {
            sort: {},
            search: {},
        ...
        i.stSafeSrc && (o = n(i.stSafeSrc), a.$watch(function () {
            ...
            var s = P.search.predicateObject || {}, i = a ? a : "$";
            ...
            var s = r(d(a)), i = s.indexOf(t);
            -1 !== i && ("single" === n ? (t.isSelected = t.isSelected !== !0, p && (p.isSelected = !1), p = t.isSelected === !0 ? t : e) : s[i].isSelected = !s[i].isSelected)
        ...
        return {
            restrict: "A", controller: "stTableController", link: function (t, e, a, n) {
        ...
        return {
            require: "^stTable", link: function (n, s, i, r) {
                var l = r, c = null, o = i.stDelay || t.search.delay, u = i.stInputEvent || t.search.inputEvent;
        ...
        return {
            restrict: "A", require: "^stTable", scope: {row: "=stSelectRow"}, link: function (e, a, n, s) {
        ...
        return {
            restrict: "A", require: "^stTable", link: function (i, r, l, c) {
                function o() {
                    P ? d = 0 === d ? 2 : d - 1 : d++;
                    var e;
                ...
                var u, p = l.stSort, g = n(p), d = 0, f = l.stClassAscent || a.sort.ascentClass, m = l.stClassDescent || a.sort.descentClass, h = [f, m], b = l.stSkipNatural !== e ? l.stSkipNatural : a.sort.skipNatural, P = l.stDescendingFirst !== e ? l.stDescendingFirst : a.sort.descendingFirst, v = null, S = l.stDelay || a.sort.delay;
        ...
        return {
            ...
            link: function (e, a, n, s) {
                function i() {
                    var t, a, n = s.tableState().pagination, i = 1, r = e.currentPage;
                    ...
                    r !== e.currentPage && e.stPageChange({newPage: e.currentPage})
                }
